...
class toMilX {
    ...
    static void main(String... args){
        ...
        File output = new File("../assets/Permanent Structures.milxly")
        File resourcesLayer =  new File("../assetsResources.milxly")
        File aiLayer = new File("../assetsAILayer.milxly")
        File scRanges = new File("../assetsSCRanges.milxly")
